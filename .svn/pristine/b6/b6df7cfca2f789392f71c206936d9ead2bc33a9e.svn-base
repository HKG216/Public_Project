...
namespace KMU.HisOrder.MVC.Areas.HisOrder.Controllers
{
    ...
    public class InputHelperController : Controller
    {
        ...
        public PartialViewResult getNonMedMenu(string inNonMedType)
        {
            ...
            switch (inNonMedType)
            {
                ...
                case "Path":
                    ...
                    break;
                case "Supply":
                    data = data.Where(c => c.ItemType != "5" && c.ItemType != "6" && c.ItemType != "7").ToList(); // Supply and Other
                    break;
                default:
                    break;
            }
            ...
            {
                p.ItemType = p.ItemType == "5" ? "Lab" : p.ItemType == "6" ? "Exam" : p.ItemType == "7" ? "Path" : p.ItemType == "8" ? "Supply" : "";
        ...
        public JsonResult SearchNonMed(string inKey, string inType)
        {
            ...
            string TypeCode = inType == "Lab" ? "5" : inType == "Exam" ? "6" : inType == "Path" ? "7" : inType == "Supply" ? "8" : "";
