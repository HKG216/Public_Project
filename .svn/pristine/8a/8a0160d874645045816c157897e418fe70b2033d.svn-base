...
function getRandomData_Med(x) {
    ...
    var list = [
        { orderplaid: '', plancode: '1XYZAL', plandes: 'Xyzal', unitdose: 'Tab' },
        { orderplaid: '', plancode: '1SOMA', plandes: 'Soma', unitdose: 'Tab' },
        { orderplaid: '', plancode: '1MIYAR', plandes: 'Miyarisan', unitdose: 'Tab' },
        { orderplaid: '', plancode: '1TOLIZ', plandes: 'Tolizole', unitdose: 'Tab' },
        { orderplaid: '', plancode: '777777', plandes: 'MsdsdsdRI', unitdose: 'Tab' },
        { orderplaid: '', plancode: '33072B', plandes: 'CsdsdT', unitdose: 'Tab' }
    ];
    ...
    $.when(
        ...
        if (r_fn_GetMedicineItem.isSuccess == true &&
            ...
            $.each(trlist, function (k, v) {
                ...
                if (checkAutoOperation(filterData) == false) {
...
function checkAutoOperation(MedItemData) {
    if (MedItemData.MedType == '1' &&
        MedItemData.UnitSpec == MedItemData.PackSpec) {
        return true;
    } else {
        return false;
    }
