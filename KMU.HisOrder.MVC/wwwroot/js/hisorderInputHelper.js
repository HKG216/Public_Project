...
function SetMedicalItemAddRow(inItemCode, inItemName, inItemGen, inItemType, inMedObj, inNonMedObj) {
...
function AddMedData(event, intr) {
    ...
    let inItemGen = $(inter).find('.GenericName').first().text();
    ...
    if (isRepeat == false) {
        SetMedicalItemAddRow(inItemCode, inItemName, inItemGen, 'Med', inMedObj, null);
    }
}
