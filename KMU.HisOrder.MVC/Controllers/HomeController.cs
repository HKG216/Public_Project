...
namespace KMU.HisOrder.MVC.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Details(string? id, string? cancelList, string? hideList)
        {
            ...
            var result = _context.Registrations.Where(R => R.RegDepartment == id && R.RegDate == d).ToList();
        ...
        public ReloadChart ChartDataCollation(DateTime? ChosenDate)
        {
            ...
            foreach (DeptForChart items in ClinicSchedules)
            {
                ...
                int Completedcount = PatientList.Count(c => c.DepCode == items.ScheDptCode && c.RegStatus == "*");
